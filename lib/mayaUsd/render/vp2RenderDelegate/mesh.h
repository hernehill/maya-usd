...
private:
    ...
    //! Per-render-item holdout shader clones. Each holdout render item gets its own clone
    //! so that VP2 fires the pre/post draw callbacks independently for each item rather
